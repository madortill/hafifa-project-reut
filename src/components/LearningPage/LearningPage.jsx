...
const LearningPage = () => {
  ...
  // --- ביטול warnings: כל ה-hooks נקראים תמיד בראש ---
  useEffect(() => {
    // החץ תמיד מופיע כברירת מחדל
    setShowNextArrow(true);

    // רק אם זה לא קרוסלה או משחק
    setIsNextArrowVisible(
  ...
  return (
    <div className="LearningPage">
      ...
      <div className="page-container-learning">
        <div className="page-content">
          {pageData.pageType === "carusel" && (
            <Carousel onLastSlideChange={setIsNextArrowVisible} />
          )}
